...
from .utils import load_file, write_file, fixg, ftimedelta, append_file, _func_, remove_from_file, is_valid_link
        ...
        if not player.playlist.entries and not player.current_entry and self.config.auto_playlist:
            ...
            while self.autoplaylist_session:
                ...
                try:
                    ...
                    await self.remove_from_autoplaylist(song_url, ex=e, delete_from_ap=False)
                    continue
